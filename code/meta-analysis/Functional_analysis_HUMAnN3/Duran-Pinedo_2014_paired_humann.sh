...
IN=/mnt/raid1/armen/Schinos/META-ANALYSIS/Duran-Pinedo_2014/Paired/For_Agamemnon/RNA/
OUT=/mnt/raid1/armen/Schinos/META-ANALYSIS/Duran-Pinedo_2014/Paired/HUMAnN/
...
for NAME in `awk '{print $1}' /mnt/raid1/armen/Schinos/META-ANALYSIS/Duran-Pinedo_2014/Paired/RNA.txt`
