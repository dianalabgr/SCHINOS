...
IN=/mnt/raid1/armen/Schinos/META-ANALYSIS/Jorth_2014/For_Agamemnon/RNA/
OUT=/mnt/raid1/armen/Schinos/META-ANALYSIS/Jorth_2014/HUMAnN/
...
echo "********************************************************************** RUNNING HUMANN********************************"
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ analyzing RNA data    s@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"

for NAME in `awk '{print $1}' /mnt/raid1/armen/Schinos/META-ANALYSIS/Jorth_2014/RNA.txt`
