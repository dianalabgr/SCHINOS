...
IN=/mnt/raid1/armen/Schinos/META-ANALYSIS/Belstrom_2021/For_Agamemnon/RNA/
OUT=/mnt/raid1/armen/Schinos/META-ANALYSIS/Belstrom_2021/HUMAnN/
mkdir $OUT
...
for NAME in `awk '{print $1}' /mnt/raid1/armen/Schinos/META-ANALYSIS/Belstrom_2021/RNA.txt`
