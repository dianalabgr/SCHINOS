...
abundances=read.delim(file="/mnt/raid1b/philip/schinos_seq/results/metagenomics/abundances/metagenomics_abundances.tsv")
column_sums=c()
column_sums_decimal=c()
# Compute the sum of each row for each column
colnames(abundances)[18]
for (i in seq(2,181,1)) {
...
write.csv(data.frame("samples"=colnames(abundances[,2:181]), "agamemnon_pairs"=column_sums, 
...
#Lets start with the GF tissue in timepoint 1 
abundances_GF_timepoint1=abundances[,which(colnames(abundances)%in%metadata_timepoint1[which(metadata_timepoint1$Sample_type_abbreviation=="GF"),"Sample_name"])]
rownames(abundances_GF_timepoint1)=abundances$Name
metadata_GF = metadata_timepoint1[which(metadata_timepoint1$Sample_type_abbreviation=="GF"),]

#Find the relative frequency of microbiomes in each group
abundances_GF_timepoint1_2= apply(abundances_GF_timepoint1,2,function(x) x/sum(x))
rownames(abundances_GF_timepoint1_2)=rownames(abundances_GF_timepoint1)
abundances_GF_timepoint1_3=abundances_GF_timepoint1_2
abundances_GF_timepoint1_3= cbind(abundances_GF_timepoint1_2,median = unlist(apply(abundances_GF_timepoint1_2, 1, median)))
abundances_GF_timepoint1_3 =  data.frame(cbind(abundances_GF_timepoint1_3,mean = unlist(apply(abundances_GF_timepoint1_2, 1, mean))))

abundances_GF_timepoint1_3[which(rownames(abundances_GF_timepoint1_3)=="Porphyromonas gingivalis"),]
abundances_GF_timepoint1_3[which(rownames(abundances_GF_timepoint1_3)=="Tannerella forsythia"),]

#Find which microbiomes we will keep
keep_GF_timepoint1_median = rownames(abundances_GF_timepoint1_3[order(abundances_GF_timepoint1_3$median, decreasing = TRUE), ])[1:100]
keep_GF_timepoint1_mean = rownames(abundances_GF_timepoint1_3[order(abundances_GF_timepoint1_3$mean, decreasing = TRUE), ])[1:100]

#Keep the 100 microbiomes with the highest median relative frequency in each group 
abundances_GF_timepoint1_4=abundances_GF_timepoint1[which(rownames(abundances_GF_timepoint1)%in%keep_GF_timepoint1_median), ]

#Create a network using GFieceasi with positive and negative connections
#samples as rows and microbiomes as columns
net_GFieceasi_GF_timepoint1_allConnections <- netConstruct(t(abundances_GF_timepoint1_4),
                                                           dataType = "counts",
                                                           filtTax = c("none"),
                                                           measure = "spieceasi", 
                                                           measurePar=list(method = "mb", nlambda = 10, 
...
#Analyze the network
props_pears_GF_timepoint1_allConnections <- netAnalyze(net_GFieceasi_GF_timepoint1_allConnections, 
                                                       centrLCC = FALSE,
                                                       avDissIgnoreInf = TRUE,
                                                       sPathNorm = FALSE,
                                                       clustMethod = "cluster_fast_greedy",
...
summary(props_pears_GF_timepoint1_allConnections)
summary(props_pears_GF_timepoint1_allConnections)
write.table(summary(props_pears_GF_timepoint1_allConnections)[1],  file("microNetProps_summary_GF_timepoint1.txt"))
write.table(summary(props_pears_GF_timepoint1_allConnections)[4],  file("microNetProps_hubs_GF_timepoint1.txt"))

feature_nodes_periodo = props_pears_GF_timepoint1_allConnections$clustering$clust1
write.csv(feature_nodes_periodo,  file("microNetProps_clusters_GF_timepoint1.csv"))
interesting_feautre_nodes = feature_nodes_periodo[which(names(feature_nodes_periodo)%in%interesting_bacteria)]
write.csv(interesting_feautre_nodes,  file("microNetProps_interesting_clusters_GF_timepoint1.csv"))
...
colors_manual_peri=c(wes_palette("GrandBudapest2")[2],"#FFFF00", wes_palette("Darjeeling2")[4], 
                     ...
                     wes_palette("Moonrise3"),wes_palette("Darjeeling1"))
#Plot the network
png("GF_timepoint1_AllConnections_MedianAbundance100Manual_labda01_nlabda30_NoPulsar.png", width = 10, height = 10, units = "in", res=600)
plot(props_pears_GF_timepoint1_allConnections, 
     nodeColor = "feature", 
     featVecCol = feature_nodes_periodo,
     colorVec = colors_manual_peri,
     nodeSize = "CSS",
...
#Lets continue with the GF tissue in timepoint 3
abundances_GF_timepoint3=abundances[,which(colnames(abundances)%in%metadata_timepoint3[which(metadata_timepoint3$Sample_type_abbreviation=="GF"),"Sample_name"])]
rownames(abundances_GF_timepoint3)=abundances$Name
metadata_GF = metadata_timepoint3[which(metadata_timepoint3$Sample_type_abbreviation=="GF"),]

#Find the relative frequency of microbiomes in each group
abundances_GF_timepoint3_2= apply(abundances_GF_timepoint3,2,function(x) x/sum(x))
rownames(abundances_GF_timepoint3_2)=rownames(abundances_GF_timepoint3)
abundances_GF_timepoint3_3=abundances_GF_timepoint3_2
abundances_GF_timepoint3_3= cbind(abundances_GF_timepoint3_2,median = unlist(apply(abundances_GF_timepoint3_2, 1, median)))
abundances_GF_timepoint3_3 =  data.frame(cbind(abundances_GF_timepoint3_3,mean = unlist(apply(abundances_GF_timepoint3_2, 1, mean))))

abundances_GF_timepoint3_3[which(rownames(abundances_GF_timepoint3_3)=="Porphyromonas gingivalis"),]
abundances_GF_timepoint3_3[which(rownames(abundances_GF_timepoint3_3)=="Edwardsiella ictaluri"),]

#Find which microbiomes we will keep
keep_GF_timepoint3_median = rownames(abundances_GF_timepoint3_3[order(abundances_GF_timepoint3_3$median, decreasing = TRUE), ])[1:100]
keep_GF_timepoint3_mean = rownames(abundances_GF_timepoint3_3[order(abundances_GF_timepoint3_3$mean, decreasing = TRUE), ])[1:100]

#Keep the 100 microbiomes with the highest median relative frequency in each group 
abundances_GF_timepoint3_4=abundances_GF_timepoint3[which(rownames(abundances_GF_timepoint3)%in%keep_GF_timepoint3_median), ]

#Create a network using GFieceasi with positive and negative connections
#samples as rows and microbiomes as columns
net_GFieceasi_GF_timepoint3_allConnections <- netConstruct(t(abundances_GF_timepoint3_4),
                                                           dataType = "counts",
                                                           filtTax = c("none"),
                                                           measure = "spieceasi", 
                                                           measurePar=list(method = "mb", nlambda = 10, 
...
#Analyze the network
props_pears_GF_timepoint3_allConnections <- netAnalyze(net_GFieceasi_GF_timepoint3_allConnections, 
                                                       centrLCC = FALSE,
                                                       avDissIgnoreInf = TRUE,
                                                       sPathNorm = FALSE,
                                                       clustMethod = "cluster_fast_greedy",
...
summary(props_pears_GF_timepoint3_allConnections)
summary(props_pears_GF_timepoint3_allConnections)
write.table(summary(props_pears_GF_timepoint3_allConnections)[1],  file("microNetProps_summary_GF_timepoint3.txt"))
write.table(summary(props_pears_GF_timepoint3_allConnections)[4],  file("microNetProps_hubs_GF_timepoint3.txt"))

feature_nodes_periodo = props_pears_GF_timepoint3_allConnections$clustering$clust1
write.csv(feature_nodes_periodo,  file("microNetProps_clusters_GF_timepoint3.csv"))
interesting_feautre_nodes = feature_nodes_periodo[which(names(feature_nodes_periodo)%in%interesting_bacteria)]
write.csv(interesting_feautre_nodes,  file("microNetProps_interesting_clusters_GF_timepoint3.csv"))
...
colors_manual_peri=c(wes_palette("GrandBudapest2")[2],"#FFFF00", wes_palette("Darjeeling2")[4], 
                     ...
                     wes_palette("Moonrise3"),wes_palette("Darjeeling1"))
#Plot the network
png("GF_timepoint3_AllConnections_MedianAbundance100Manual_labda01_nlabda30_NoPulsar.png", width = 10, height = 10, units = "in", res=600)
plot(props_pears_GF_timepoint3_allConnections, 
     nodeColor = "feature", 
     featVecCol = feature_nodes_periodo,
     colorVec = colors_manual_peri,
     nodeSize = "CSS",
...
#Differential network 
net_GFieceasi_GF_difference <- netConstruct(data = t(abundances_GF_timepoint3_4),
                                            data2 = t(abundances_GF_timepoint1_4),
                                            dataType = "counts",
                                            filtTax = c("none"),
                                            measure = "spieceasi", 
                                            measurePar=list(method = "mb", nlambda = 10, 
                                            ...
                                            seed = 123456)
#Analyze the network
props_pears_GF_difference <- netAnalyze(net_GFieceasi_GF_difference, 
                                        centrLCC = FALSE,
                                        avDissIgnoreInf = TRUE,
                                        sPathNorm = FALSE,
                                        clustMethod = "cluster_fast_greedy",
...
summary(props_pears_GF_difference)

png("GF_difference_AllConnections_MedianAbundance100Manual_labda01_nlabda10_NoPulsar.png", width = 10, height = 10, units = "in", res=600)
plot(props_pears_GF_difference, 
     sameLayout = TRUE, 
     layoutGroup = 1,
     rmSingles = "inboth", 
     nodeSize = "CSS",
...
write.table(summary(props_pears_GF_difference)[1],  file("microNetProps_summary_GF_difference.txt"))
write.table(summary(props_pears_GF_difference)[4],  file("microNetProps_hubs_GF_difference.txt"))
